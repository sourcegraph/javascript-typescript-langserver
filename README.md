...
[![Windows Build Status](https://ci.appveyor.com/api/projects/status/==========SECRET=======/branch/master?svg=true)](https://ci.appveyor.com/project/sourcegraph/javascript-typescript-langserver/branch/master)
