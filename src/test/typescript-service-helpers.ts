...
export function describeTypeScriptService(createService: TypeScriptServiceFactory, shutdownService = shutdownTypeScriptService, rootUri: string): void {
    ...
    describe('Workspace with root package.json', function(this: TestContext & ISuiteCallbackContext): void {
        ...
        describe('workspaceSymbol()', function(this: TestContext & ISuiteCallbackContext): void {
            describe('with SymbolDescriptor query', function(this: TestContext & ISuiteCallbackContext): void {
                it('should find a symbol by name, kind and package name', async function(this: TestContext & ITestCallbackContext): Promise<void> {
                    const result: SymbolInformation[] = await this.service.workspaceSymbol({
                        symbol: {
                            name: 'a',
                            kind: 'class',
            ...
            describe('with text query', function(this: TestContext & ISuiteCallbackContext): void {
                it('should find a symbol', async function(this: TestContext & ITestCallbackContext): Promise<void> {
                    const result: SymbolInformation[] = await this.service.workspaceSymbol({ query: 'a' })
        ...
        describe('workspaceXreferences()', function(this: TestContext & ISuiteCallbackContext): void {
            it('should return all references to a method', async function(this: TestContext & ITestCallbackContext): Promise<void> {
            ...
            it('should return all references to a method with hinted dependee package name', async function(this: TestContext & ITestCallbackContext): Promise<void> {
                const result: ReferenceInformation[] = await this.service.workspaceXreferences({
                        query: {
                            name: 'foo',
                            kind: 'method',
                            containerName: 'a'
            ...
            it('should return no references to a method if hinted dependee package name was not found', async function(this: TestContext & ITestCallbackContext): Promise<void> {
                const result = await this.service.workspaceXreferences({
                    query: {
                        name: 'foo',
                        kind: 'method',
                        containerName: 'a'
            ...
            it('should return all references to a symbol from a dependency', async function(this: TestContext & ITestCallbackContext): Promise<void> {
    ...
    describe('Dependency detection', function(this: TestContext & ISuiteCallbackContext): void {
        ...
        describe('workspaceXdependencies()', function(this: TestContext & ISuiteCallbackContext): void {
            it('should account for all dependencies', async function(this: TestContext & ITestCallbackContext): Promise<void> {
        ...
        describe('workspaceXpackages()', function(this: TestContext & ISuiteCallbackContext): void {
            it('should accournt for all packages', async function(this: TestContext & ITestCallbackContext): Promise<void> {
    ...
    describe('Live updates', function(this: TestContext & ISuiteCallbackContext): void {
        ...
        it('should handle didChange when configuration is not yet initialized', async function(this: TestContext & ITestCallbackContext): Promise<void> {
        ...
        it('should handle didClose when configuration is not yet initialized', async function(this: TestContext & ITestCallbackContext): Promise<void> {
    ...
    describe('Diagnostics', function(this: TestContext & ISuiteCallbackContext): void {
        ...
        it('should publish diagnostics on didOpen', async function(this: TestContext & ITestCallbackContext): Promise<void> {
        ...
        it('should publish diagnostics on didChange', async function(this: TestContext & ITestCallbackContext): Promise<void> {
        ...
        it('should publish empty diagnostics on didChange if error was fixed', async function(this: TestContext & ITestCallbackContext): Promise<void> {
        ...
        it('should clear diagnostics on didClose', async function(this: TestContext & ITestCallbackContext): Promise<void> {
    ...
    describe('textDocumentRename()', function(this: TestContext & ISuiteCallbackContext): void {
        ...
        it('should error on an invalid symbol', async function(this: TestContext & ITestCallbackContext): Promise<void> {
    ...
    describe('workspaceExecuteCommand()', function(this: TestContext & ISuiteCallbackContext): void {
        ...
        describe('codeFix', () => {
            it('should apply a WorkspaceEdit for the passed FileTextChanges', async function(this: TestContext & ITestCallbackContext): Promise<void> {
